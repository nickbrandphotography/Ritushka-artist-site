...
export default function Page() {
  return (
    <Prose title="Artwork installation guide" intro="How to hang, light and care for your original painting." crumbs={[{ name: 'Home', path: '/' }, { name: 'Installation Guide', path: '/installation-guide' }]}>
      ...
      <p>Centre the work at approximately 145–150cm from the floor to the painting&rsquo;s midpoint. Above a sofa or console, leave 15–25cm between the furniture top and the frame.</p>
      <h2>Fixings</h2>
      <p>Use fixings rated well above the work&rsquo;s weight and anchor into studs or use appropriate masonry/plasterboard anchors. Large works should use two points for stability and levelling.</p>
      <h2>Lighting</h2>
      ...
      <h2>Prefer it done for you?</h2>
      <p>
        A hands-on installation service is available — see <Link href="/shipping">shipping &amp; delivery</Link>{' '}
        for details, or explore <Link href="/framing">custom framing</Link> before the piece arrives.
      </p>
    </Prose>
  );
}
