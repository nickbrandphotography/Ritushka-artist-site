...
export const programs: Record<string, Program> = {
  'interior-designers': {
    ...
    seoTitle: 'Art for Interior Designers | Trade Program | Ritushka',
  ...
  'art-consultants': {
    ...
    seoTitle: 'Art Consultant Services | Trade Program | Ritushka',
  ...
  'buyers-agents': {
    ...
    seoTitle: "Art for Buyer's Agents & Property Styling | Ritushka",
  ...
  'corporate': {
    ...
    seoTitle: 'Corporate Art Services & Commissions | Ritushka',
